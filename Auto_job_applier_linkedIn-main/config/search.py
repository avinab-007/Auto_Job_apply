...
search_terms = ["Risk Analyst", "Financial Analyst","Credit Risk Analys", "Business Risk Analyst", "Operation Risk Analyst", "Australian Accountant", "American Accountant"]

# Search location, this will be filled in "City, state, or zip code" search box. If left empty as "", tool will not fill it.
search_location = "Ahmedabad, Gujarat, India"               # Some valid examples: "", "United States", "India", "Chicago, Illinois, United States", "90001, Los Angeles, California, United States", "Bengaluru, Karnataka, India", etc.
...
location = ["Ahmedabad", "Gandhinagar"]                      # (dynamic multiple select)
...
about_company_good_words = ["Fresher","0-5 years of experience"]      # (dynamic multiple search) or leave empty as []. Ex: ["Robert Half", "Dice"]
